...
| `test-local.sh` | Local dev servers (8 scenarios: static, React, Flask, Functions, SWA CLI, Next.js, Monorepo, Container App) | No |
...
| `container-app/` | Containerized Node.js | `docker-compose up` | Container Apps |
